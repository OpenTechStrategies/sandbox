...
Sandbox repository for probing GitHub features.

...such as GitHub-flavored Markdown, since for some reason I don't
seem to be able to create gists (the site behaves in a very wonky way
when I try).  So:
